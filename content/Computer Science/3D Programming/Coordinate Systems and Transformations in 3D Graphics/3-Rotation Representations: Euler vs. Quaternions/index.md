...
Let's focus on the 2D plane. WHy? It's the smallest space that alloows for rotations. If you doubt it, try to think how a rotation would happen in 1D. 
...
What this means actially is the following:
...
I challenge you to do a simple exercise. Keep this mental model of an axis of rotation and the place perpendicular to it, and try to rotate your phone with your hand. Try to see how this is true.
